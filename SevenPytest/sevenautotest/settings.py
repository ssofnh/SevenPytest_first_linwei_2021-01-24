...
# HTML测试报告文件名
HTML_REPORT_NAME = "linwei_autotest_report.html"
...
TEST_FILE4 = os.path.join(TESTCASES_DIR, 'AddTest.py::AddTest::test_add')

TESTCASES = [TEST_FILE4]
# 执行测试的pytest命令     参数--disable-warnings 禁止显示警告信息
PYTEST_COMMANDS = [ '-s','--html=%s' % HTML_REPORT_FILE_PATH, '--self-contained-html',' --capture=sys'] + TESTCASES
# PYTEST_COMMANDS = ["-s"] + TESTCASES
